      ...
      <div className="Body" id="body">
        ...
        <div className="Info-container">
          ...
          <div className="Other-info">
            ...
            {hasBeenSearched ? <OtherInfoCard propName={"Wind Status"} propInfo={Math.trunc(windStatus) + " mph"} /> : <OtherInfoCard />}
            {hasBeenSearched ? <OtherInfoCard propName={"Sunrise & Sunset"} propInfo={getSunset(set)} propInfo2={getSunrise(rise)} /> : <OtherInfoCard />}
